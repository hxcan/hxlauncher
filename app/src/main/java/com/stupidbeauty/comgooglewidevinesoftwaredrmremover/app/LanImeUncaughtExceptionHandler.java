...
public class LanImeUncaughtExceptionHandler implements UncaughtExceptionHandler 
{
	...
	{
		File goddessCameraDirectory=new File(LanImeBaseDef.getLogBaseDir() ); // 女神相机目录。
	...
	public LanImeUncaughtExceptionHandler()
	{
		...
		mExceptionPath = LanImeBaseDef.getLogBaseDir() + File.separator + LanImeBaseDef.EXCEPTION_FILE; //构造异常文件路径。
