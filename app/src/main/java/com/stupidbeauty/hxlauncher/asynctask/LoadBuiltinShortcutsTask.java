...
public class LoadBuiltinShortcutsTask extends AsyncTask<Object, Void, Object>
{
	...
	private static final String TAG="LoadBuiltinShortcutsTask"; //!<输出调试信息时使用的标记。
...
//         mAdapter.notifyDataSetChanged(); //通知数据变更。
    ...
    protected void onPostExecute(Object result)
    {
        ...
        launcherActivity.setBuiltinShortcuts(articleInfoArrayList); // 设置内置快捷方式列表。
